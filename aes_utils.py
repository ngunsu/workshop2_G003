import hashlib
#import os no se estaba utilizando, se puede eliminar
...
def encriptar(texto: str, llave: str) -> str:
    ...
    return ct.hex()
#se cambio asscii por utf-8 para soportar caracteres especiales.
#se cambio get_random_bytes(16) por get_random_bytes(32)
