"""
Funciones auxiliares para encriptar y desencriptar texto con AES-256-CBC
"""
...
# se cambio la codificacion de ascii a utf-8 para soportar caracteres especiales y emojis
# se corrigio la funcion encriptar para concatenar iv + ciphertext en la salida
...
# se ajusto la funcion desencriptar para usar AES.block_size (16) en lugar de AES.block_size *2
# se agrego la decodificacion utf-8.
