"""
CLI para desencriptar texto cifrado con AES-256-CBC
"""
...
@app.command()
def main(
    texto_encriptado: str = typer.Argument(
        ..., help="Texto encriptado en formato hex."
    ),
    llave: str = typer.Argument(
        ..., help="Llave secreta usada durante la encriptación."
    ),
):
    """
    ...
    try:
        ...
        console.print(
            Panel(
                f"[bold cyan]{resultado}[/]", title="Texto Desencriptado", expand=False
            )
        )
    except Exception as exc:
        console.print(
            "[bold red]Error:[/] llave incorrecta o texto encriptado inválido."
        )
