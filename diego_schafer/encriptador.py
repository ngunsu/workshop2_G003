"""
CLI para encriptar texto usando AES-256-CBC
"""
...
def main(
    ...
    console.print(
        Panel(f"[bold green]{resultado}[/]", title="Texto Encriptado", expand=False)
    )


# se cambio Resultado a resultado para seguir la convencion de nombrado en minuscula
